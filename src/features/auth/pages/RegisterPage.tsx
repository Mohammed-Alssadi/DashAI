...
export function RegisterPage() {
  ...
  return (
    <div className="relative min-h-screen w-full bg-background text-foreground flex flex-col items-center justify-center overflow-hidden font-sans p-4 selection:bg-accent selection:text-accent-foreground">
      ...
      <div className="absolute top-[-10%] left-[10%] w-[300px] md:w-[500px] h-[300px] md:h-[500px] rounded-full bg-primary/10 blur-[80px] md:blur-[120px] pointer-events-none" />
      <div className="absolute bottom-[10%] right-[5%] w-[250px] md:w-[450px] h-[250px] md:h-[450px] rounded-full bg-accent/30 blur-[80px] md:blur-[120px] pointer-events-none" />
